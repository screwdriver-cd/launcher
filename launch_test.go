...
func TestMain(m *testing.M) {
	...
	executorRun = func(path string, env []string, emitter screwdriver.Emitter, build screwdriver.Build, api screwdriver.API, buildID int, shellBin string, userShellBin string, timeout int) error {
		return nil
	}
	cleanExit = func() {}
...
func TestUpdateBuildNonZeroFailure(t *testing.T) {
	...
	executorRun = func(path string, env []string, out screwdriver.Emitter, build screwdriver.Build, a screwdriver.API, buildID int, shellBin string, userShellBin string, timeout int) error {
