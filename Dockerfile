...
RUN set -x \
   ...
   # Download zstd
   && wget -q -O zstd-cli-linux.tar.gz "https://github.com/screwdriver-cd/sd-packages/releases/download/v0.0.38/zstd-cli-linux.tar.gz"
...
RUN set -x \
   ...
   # Download zstd
   && wget -q -O zstd-cli-linux.tar.gz "https://github.com/screwdriver-cd/sd-packages/releases/download/v0.0.38/zstd-cli-linux-aarch64.tar.gz" \
...
RUN set -x \
   ...
   # Install skope
   && wget -q -O skopeo-linux.tar.gz "https://github.com/screwdriver-cd/sd-packages/releases/download/v0.0.38/skopeo-linux.tar.gz" \
   && tar -C . -ozxvf skopeo-linux.tar.gz \
   && chmod +x skopeo \
   # Install zstd
   && wget -q -O zstd-cli-macosx.tar.gz "https://github.com/screwdriver-cd/sd-packages/releases/download/v0.0.38/zstd-cli-macosx.tar.gz" \
